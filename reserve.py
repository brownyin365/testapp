...
class MenuBuilder:
    ...
    def main_menu(user_id):
        ...
        referral_stats_button = InlineKeyboardButton("📊 View Referral Stats", web_app={"url": f"https://d644-197-251-193-137.ngrok-free.app/referral_stats/{user_id}"})
        ...
        dashboard_button = InlineKeyboardButton(
            "📊 View Dashboard",
            web_app={
                "url": f"https://d644-197-251-193-137.ngrok-free.app/{deep_link}"
            }
        )
